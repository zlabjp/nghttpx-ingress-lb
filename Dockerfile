...
RUN apt-get update && \
    ...
    git clone --depth 1 -b v1.45.1 https://github.com/nghttp2/nghttp2.git && \
    cd nghttp2 && \
...
FROM gcr.io/distroless/cc-debian10@sha256:627e2aade1375412f5e4d9f9e9ff47049feff37f0214625517a0298dc1d1adb0
