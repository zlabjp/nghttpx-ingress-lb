...
COPY patches/extra-mrbgem.patch patches/0001-nghttpx-Fix-bug-that-stalls-TLS-write.patch /
...
RUN git clone --depth 1 -b v0.12.1 https://github.com/ngtcp2/ngtcp2 && \
    cd ngtcp2 && \
    autoreconf -i && \
    ./configure --enable-lib-only \
