...
RUN git clone --depth 1 -b v1.39.0 https://github.com/aws/aws-lc && \
    cd aws-lc && \
...
RUN git clone --recursive --shallow-submodules --depth 1 -b v1.9.1 https://github.com/ngtcp2/ngtcp2 && \
    cd ngtcp2 && \
    autoreconf -i && \
...
RUN git clone --recursive --shallow-submodules --depth 1 -b v1.64.0 https://github.com/nghttp2/nghttp2.git && \
    cd nghttp2 && \
