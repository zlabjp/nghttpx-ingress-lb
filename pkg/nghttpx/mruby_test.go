...
// TestCreatePerBackendMrubyChecksumFile verifies CreatePerBackendMrubyChecksumFile.
func TestCreatePerBackendMrubyChecksumFile(t *testing.T) {
	const (
	...
	f := CreatePerBackendMrubyChecksumFile("/foo/bar", content)
